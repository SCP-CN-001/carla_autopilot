...
class LeaderboardEvaluator:
    ...
    def _register_statistics(
        self, route_date_string, route_index, entry_status, crash_message=""
    ):
        """
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            result = self._register_statistics(
                route_date_string, config.index, entry_status, crash_message
            )
        ...
        try:
            ...
            if args.record:
                self.client.start_recorder(
                    "{}.log".format(args.record), False
                )  # changed to False, otherwise the log file become too large
