...
class MapImage:
    ...
    def draw_lane_marking_single_side(
        ...
        for (
            ...
            markings_list
        ):  # markings is a 3-tuple of (carla.libcarla.LaneMarkingType, carla.libcarla.LaneMarkingColor, list of waypoint pairs)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--carla_sh_path", default="~/software/CARLA_Leaderboard_20/CarlaUE4.sh"
    )
    ...
    server_manager = CarlaServerManager(
        args.carla_sh_path, port=2000, configs=env_config
    )
