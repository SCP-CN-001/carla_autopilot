...
class ExpertAgent(AutoPilot):
    ...
    def tick(self, input_data):
        ...
        resized = cv2.resize(
            bev_semantics["bev_semantic_classes"],
            (0, 0),
            fx=2,
            fy=2,
        ...
        resized = cv2.resize(
            bev_semantics_augmented["bev_semantic_classes"],
            (0, 0),
            fx=2,
            fy=2,
            interpolation=cv2.INTER_NEAREST,
    ...
    def get_bounding_boxes(self, lidar=None):
        ...
        for walker in walkers:
            if (
                ...
                if walker_wp.road_id == ego_wp.road_id:
                    ...
                    if same_direction_as_ego:
                        lane_relative_to_ego = abs(
                            walker_wp.lane_id - lane_id_left_most_lane_same_direction
                        )
                    else:
                        lane_relative_to_ego = (
                            -1
        ...
        for stop_sign in stop_signs:
            ...
            if stop_sign_wp.road_id == ego_wp.road_id:
                ...
                if same_direction_as_ego:
                    lane_relative_to_ego = abs(
                        stop_sign_wp.lane_id - lane_id_left_most_lane_same_direction
                    )
                else:
                    lane_relative_to_ego = (
                        -1
                        * abs(
                            stop_sign_wp.lane_id
                            - lane_id_right_most_lane_opposite_direction
                        )
                        - 1
                    )
        ...
        for static in statics:
            if (
                ...
                if static_wp.road_id == ego_wp.road_id:
                    ...
                    if same_direction_as_ego:
                        lane_relative_to_ego = abs(
                            static_wp.lane_id - lane_id_left_most_lane_same_direction
                        )
                    else:
                        lane_relative_to_ego = (
                            -1
